...
class WaitlistEntry(Base):
    ...
    # Preferences
    worth_joining: Mapped[list[str] | None] = mapped_column(StringArray(50), nullable=True)
    ...
    looking_for: Mapped[list[str] | None] = mapped_column(StringArray(50), nullable=True)
    what_matters: Mapped[list[str] | None] = mapped_column(StringArray(50), nullable=True)
    bring_to_table: Mapped[list[str] | None] = mapped_column(StringArray(50), nullable=True)
    # Attribution
